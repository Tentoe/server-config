...
resource "openstack_compute_instance_v2" "kubeworker1" {
...
resource "openstack_dns_recordset_v2" "kubeworker1" {
  zone_id = openstack_dns_zone_v2.default.id
  name    = "${openstack_compute_instance_v2.kubeworker1.name}.${openstack_dns_zone_v2.default.name}"
  type    = "A"
  records = [openstack_compute_instance_v2.kubeworker1.access_ip_v4]
}